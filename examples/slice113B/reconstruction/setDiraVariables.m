...
smd.dt1 = 0.00069;        % detector element size
smd.interpolation = 2;    % Joseph projection generation
smd.N0 = 736;             % nr of detector elements
smd.M0 = 1152;            % nr of projections
smd.M1 = 720;             % new nr of projections
smd.fact = 4;             % factor for no rebinned projections
smd.dfi0 = 360 / smd.M0;  % angle increment in degrees
smd.dfi1 = 180 / smd.M1;  % new angle increment in degrees
smd.dt0 = 0.067864004196156*pi/180;  % Detector element arc length [rad]
