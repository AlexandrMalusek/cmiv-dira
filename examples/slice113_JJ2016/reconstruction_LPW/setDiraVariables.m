...
% Reference volume and atlas for the JJ2016
load('referenceImage.mat');

pmd.referenceImage = referenceImage;
pmd.referenceMask  = referenceMask;
pmd.atlasImage     = rgb2gray(imread('atlasImage.png'));
clear referenceImage referenceMask atlasImage;
